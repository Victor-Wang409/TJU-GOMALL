...
type EmailReq struct {
	...
	From        string `protobuf:"bytes,1,opt,name=form,proto3" json:"form,omitempty"`
...
func (x *EmailReq) GetForm() string {
	if x != nil {
		return x.From
	}
	return ""
...
var file_email_proto_rawDesc = []byte{
	...
	0x71, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x66, 0x6f, 0x72, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28,
